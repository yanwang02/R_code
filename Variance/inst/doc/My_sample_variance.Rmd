...
Firstly, we will check that sample mean gives correct value by calculating the sample mean for the numbers 1 to 10. 
...
We can check this is correct with following
